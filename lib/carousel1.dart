...
final List<String> project_description_paragraph_1=[
 "Used HTML to create the popup page of Tab Locker extension, which appears when it's icon is being clicked.",
...
final List<String> project_description_paragraph_2=[
 'Used JavaScript for other pages of that extension.',
